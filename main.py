...
def main_worker(zmq_addres, zmq_ui_port, zmq_prm_port, zmq_mon_port):
    try:
        toExit = False
...
if __name__ == '__main__':
    try:
        ...
        for i in range(num_main_workers):
            main_worker_proc = multiprocessing.Process(target=main_worker, args=(zmq_address, "5554", "5555", "5557"))
